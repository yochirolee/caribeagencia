								...
								<div class="shadow-lg w-full bg-white dark:bg-gray-700 relative overflow-hidden">
									<a href="#" class="w-full h-full block">
										...
										<div class="w-full h-3 bg-gray-100">
											<div class="w-2/5 h-full text-center text-xs text-white bg-green-400"></div>
										</div>
									</a>
								</div>
							</div>
							<div class="flex items-center w-full md:w-1/2 space-x-4">
								<div class="w-1/2">
									<div class="shadow-lg px-4 py-6 w-full bg-white dark:bg-gray-700 relative">
										<p class="text-2xl text-black dark:text-white font-bold">12</p>
										<p class="text-gray-400 text-sm">Active projects</p>
									</div>
								</div>
								<div class="w-1/2">
									<div class="shadow-lg px-4 py-6 w-full bg-white dark:bg-gray-700 relative">
										<p class="text-2xl text-black dark:text-white font-bold">$93.76</p>
						...
						<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 my-4">
							<div class="w-full">
								<div class="shadow-lg px-4 py-6 w-full bg-white dark:bg-gray-700 relative">
									...
									<div class="flex items-end space-x-2 my-6">
										<p class="text-5xl text-black dark:text-white font-bold">12</p>
							...
							<div class="w-full">
								<div class="shadow-lg px-4 py-6 w-full bg-white dark:bg-gray-700 relative">
									...
									<div class="flex items-end space-x-2 my-6">
										<p class="text-5xl text-black dark:text-white font-bold">23</p>
										<span class="text-green-500 text-xl font-bold flex items-center">
											<svg
												width="20"
												fill="currentColor"
							...
							<div class="w-full">
								<div class="shadow-lg px-4 py-6 w-full bg-white dark:bg-gray-700 relative">
									...
									<div class="flex items-end space-x-2 my-6">
										<p class="text-5xl text-black dark:text-white font-bold">16</p>
										<span class="text-red-500 text-xl font-bold flex items-center">
											<svg
												width="20"
												fill="currentColor"
							...
							<div class="w-full">
								<div class="shadow-lg px-4 py-6 w-full bg-white dark:bg-gray-700 relative">
									...
									<div class="flex items-end space-x-2 my-6">
										<p class="text-5xl text-black dark:text-white font-bold">9</p>
										<span class="text-green-500 text-xl font-bold flex items-center">
											<svg
												width="20"
												fill="currentColor"
							...
							<div class="w-full">
								<div class="shadow-lg px-4 py-6 w-full bg-white dark:bg-gray-700 relative">
									...
									<div class="flex items-end space-x-2 my-6">
										<p class="text-5xl text-black dark:text-white font-bold">15</p>
										<span class="text-green-500 text-xl font-bold flex items-center">
											<svg
												width="20"
												fill="currentColor"
