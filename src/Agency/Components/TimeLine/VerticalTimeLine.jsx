...
export const VerticalTimeLine = () => {
	return (
		<ol className="grid grid-cols-3 w-1/2 mx-auto gap-4   border-t border-gray-200 dark:border-gray-700">
			<li className="mb-10 mt-6 relative  flex-col">
				<span className=" absolute -top-7 left-16   w-2 h-2 rounded-full bg-white ring ring-blue-600 dark:ring-gray-900 dark:bg-blue-900"></span>
