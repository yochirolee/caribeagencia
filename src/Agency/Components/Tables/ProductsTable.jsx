...
import LocationSelect from "../ui/Selects/LocationSelect";
...
const getUniqueLocations = (filteredProducts) => {
...
export const ProductsTable = ({
	...
	return (
		<div className=" grid   min-w-full ">
			<div name="actions" className="my-4 flex gap-4 items-center justify-between">
				<div>
					<span className="inline-flex gap-2 my-2 items-center px-2 py-1 mr-2 text-sm font-medium text-gray-800 bg-gray-100 rounded dark:bg-gray-700 dark:text-gray-300">
						<p>Total HBL: </p>
